...
const GrnList = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      try {
        await deleteGrn(id); // Call API
        // Remove item from UI immediately without reloading
                          ...
                          <tr key={item.id}>
                            ...
                            <td>
                              <button 
                                ...
                                onClick={() => handleDelete(item.id)} // Attached Function
                              >
                                <FaTrash />
                              </button>
                            </td>
                            ...
                            <td>
                              <button 
                                ...
                                onClick={() => handleEdit(item.id)} // Attached Function
                              >
                                <FaEdit />
                              </button>
                            </td>
