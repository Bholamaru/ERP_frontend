...
useEffect(() => {
    const fetchLotNumbers = async () => {
        ...
        try {
            ...
            if (currentOpNum === 10 || currentIndex === 0) {
                // ✅ FORMAT 1: First Operation Response
                ...
                if (response.data.heat_qty_list && Array.isArray(response.data.heat_qty_list)) {
                    ...
                    console.log("✅ First OP Format - heat_qty_list found:", lotsData)
                }
            } else {
                // ✅ FORMAT 2: Subsequent Operations Response
                // {
                ...
                console.log("🔍 Searching for previous OP key:", previousOPNo)
                ...
                if (matchingKey) {
                    ...
                    console.log("📦 Heat Data for key:", heatData)
                    ...
                    console.log("✅ Converted to array format:", lotsData)
                } else {
                    console.warn(`⚠️ No data found for previous OP: ${previousOPNo}`)
                }
            }
