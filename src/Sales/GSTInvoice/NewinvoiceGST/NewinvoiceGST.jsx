                          ...
                          <div className="row text-start">
                            ...
                            <div className="col-md-4">
                              ...
                              <div className="row mb-2">
                                ...
                                <div className="col-2">
                                  <label htmlFor="payment">Note :</label>
                                </div>
                                <div className="col-3">
                                  <input
                                    type="text"
                              ...
                              <div className="row mb-2">
                                ...
                                <div className="col-2">
                                  <label htmlFor="unit-machine">Freight:</label>
                                </div>
                              ...
                              <div className="row mb-2">
                                <div className="col-4">
                                  <label htmlFor="unit-machine">PDI No :</label>
                                </div>
                                <div className="col-2">
                                  <input
                                    type="text"
                                ...
                                <div className="col-2">
                                  <label htmlFor="unit-machine">Bank:</label>
                                </div>
                                <div className="col-4 d-flex align-items-center">
                                  <select className="form-control flex-grow-1">
                                    <option> Select </option>
                    ...
                    <table className="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td></td>
                          <td>
                            <input type="text" className="w-50" /> <br />
                            Per Pcs Wt: <br />
                            <input
                              type="text"
                              className="w-50"
