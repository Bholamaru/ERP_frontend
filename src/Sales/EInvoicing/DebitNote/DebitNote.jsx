                    ...
                    <div className="row align-items-center">
                      <div className="col-md-4">
                        <h5 className="header-title">
                          Pending Debit Note List For E-Invoice
                        </h5>
                      </div>
                      ...
                      <div className="col-md-2 cancelirn">
                        <input
                          type="radio"
                          id="CancelIRN"
                          name="brand"
                    ...
                    <div className="row text-start">
                      ...
                      <div className="col-md-1">
                        <div className="d-flex  justify-content-center align-items-center">
                          ...
                          <label htmlFor="customer-checkbox" className="ms-2">
                            Customer:
                          </label>
                        </div>
                        <input
                      ...
                      <div className="col-md-1">
                        <div className="d-flex justify-content-center align-items-center">
                          ...
                          <label htmlFor="Item-checkbox" className="ms-1">
                            Item:
                          </label>
                        </div>
                        <input
                      ...
                      <div className="col-md-1">
                        <div className="d-flex justify-content-center align-items-center">
                          ...
                          <label htmlFor="Invoice-checkbox" className="ms-2">
                            Invoice:
                          </label>
                        </div>
                        <input
                          ...
                          <div className="DebitNote-header mb-4 text-start">
                            <div className="row align-items-center">
                              <div className="col-md-3">
                                <h5 className="header-title cllllr">
                                  Invoice No. Customer
                                </h5>
                              </div>
                            </div>
