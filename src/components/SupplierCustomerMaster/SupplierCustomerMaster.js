                  ...
                  <div className="SupplierCus-header mb-4 text-start">
                    <div className="row align-items-center">
                      <div className="col-md-4">
                        <h5 className="header-title">Supplier / Customer Master</h5>
                      </div>
                                  ...
                                  <form onSubmit={handleSubmit} autoComplete="off">
                                    <div className="row text-start">
                                      <div className="col-md-4" style={{ padding: "10px" }}>
                                        ...
                                        {/* PAN No. */}
                                        <div className="row mb-3">
                                          <label className="col-sm-4 col-form-label" htmlFor="PAN_No">
                                        ...
                                        {/* PAN type */}
                                        <div className="row mb-3">
                                          <label htmlFor="PAN_Type" className="col-sm-4 col-form-label">
                                            Pan Type:
                                        ...
                                        {/* Invoice Type */}
                                        <div className="row mb-3">
                                          <label htmlFor="Invoice_Type" className="col-sm-4 col-form-label">
                                            Invoice Type:
                                          </label>
                                          <div className="col-sm-5">
                                            <select
                                        ...
                                        {/* CIN No */}
                                        <div className="row mb-3">
                                          <label htmlFor="CIN_No" className="col-sm-4 col-form-label">
                                            CIN No:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Contact No */}
                                        <div className="row mb-3">
                                          <label htmlFor="Contact_No" className="col-sm-4 col-form-label">
                                            Contact No:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        <div className="row mb-3">
                                          <div className="form-check col-sm-4">
                                            ...
                                            />
                                            <label className="form-check-label" htmlFor="TCS">
                                              TCS:
                                            </label>
                                          </div>
                                          <div className="col-sm-8">
                                        ...
                                        <div className="row mb-3">
                                          <div className="form-check col-sm-4">
                                            <label className="form-check-label" htmlFor="Insurance_Policy_No">
                                              Insurance Policy No:
                                            </label>
                                          </div>
                                          <div className="col-sm-8">
                                        ...
                                        <div className="row mb-3">
                                          <div className="form-check col-sm-4">
                                            <label className="form-check-label" htmlFor="Subcon_Challan">
                                              Subcon Challan:
                                            </label>
                                          </div>
                                          <div className="col-sm-8">
                                        ...
                                        {/* GL */}
                                        <div className="row mb-3">
                                          <label htmlFor="GL" className="col-sm-4 col-form-label">
                                            GL:
                                          </label>
                                          <div className="col-sm-8">
                                            <select
                                      ...
                                      <div className="col-md-4" style={{ padding: "10px" }}>
                                        ...
                                        {/* State Code */}
                                        <div className="row mb-3">
                                          <label htmlFor="State_Code" className="col-sm-4 col-form-label">
                                        ...
                                        {/* GST Tax Code */}
                                        <div className="row mb-3">
                                          <label htmlFor="GST_Tax_Code" className="col-sm-4 col-form-label">
                                        ...
                                        {/* Address Line 1 */}
                                        <div className="row mb-3">
                                          <label htmlFor="Address_Line_1" className="col-sm-4 col-form-label">
                                        ...
                                        {/* Incoterms */}
                                        <div className="row mb-3">
                                          <label htmlFor="Incoterms" className="col-sm-4 col-form-label">
                                            Incoterms:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* VAT TIN */}
                                        <div className="row mb-3">
                                          <label htmlFor="VAT_TIN" className="col-sm-4 col-form-label">
                                            VAT TIN:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* LUT No */}
                                        <div className="row mb-3">
                                          <label htmlFor="LUT_No" className="col-sm-4 col-form-label">
                                            LUT No:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Monthly Sale */}
                                        <div className="row mb-3">
                                          <label htmlFor="Montly_Sale" className="col-sm-4 col-form-label">
                                            Monthly Sales:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                      ...
                                      <div className="col-md-4" style={{ padding: "10px" }}>
                                        ...
                                        {/* Distance */}
                                        <div className="row mb-3">
                                          <label htmlFor="Distance" className="col-sm-4 col-form-label">
                                            Distance:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Vendor Code */}
                                        <div className="row mb-3">
                                          <label htmlFor="Vendor_Code" className="col-sm-4 col-form-label">
                                            Vendor Code:{" "}
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        <div className="row mb-3">
                                          <label htmlFor="Legal_Name_GST" className="col-sm-4 col-form-label">
                                            Legal Name (As Per GST):
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Cust Short Name */}
                                        <div className="row mb-3">
                                          <label htmlFor="Cust_Short_Name" className="col-sm-4 col-form-label">
                                            Cust Short Name:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* MSME Type */}
                                        <div className="row mb-3">
                                          <label htmlFor="MSME_Type" className="col-sm-4 col-form-label">
                                            MSME Type:
                                          </label>
                                          <div className="col-sm-8">
                                            <select
                                        ...
                                        {/* ISO */}
                                        <div className="row mb-3">
                                          <label htmlFor="ISO" className="col-sm-4 col-form-label">
                                            ISO:
                                          </label>
                                          <div className="col-sm-8">
                                            <select
                                        ...
                                        {/* Active */}
                                        <div className="row mb-3">
                                          <label htmlFor="Active" className="col-sm-4 col-form-label">
                                            Active:
                                          </label>
                                        ...
                                        <div className="row mb-3">
                                          <label htmlFor="QMSC_Date" className="col-sm-4 col-form-label">
                                            QMSC Date:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Std Packing */}
                                        <div className="row mb-3">
                                          <label htmlFor="Std_Packing" className="col-sm-4 col-form-label">
                                            Std Packing:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Old ERP Code */}
                                        <div className="row mb-3">
                                          <label htmlFor="Old_ERP_Code" className="col-sm-4 col-form-label">
                                            Old ERP Code:
                                          </label>
                                          ...
                                          <label htmlFor="Delivery_Lead_Time" className="col-sm-2 col-form-label">
                                            Delivery Lead Time:
                                          </label>
                                          <div className="col-sm-3">
                                            <input
                                        ...
                                        {/* EORI No */}
                                        <div className="row mb-3">
                                          <label htmlFor="EORI_No" className="col-sm-4 col-form-label">
                                            EORI No:
                                          </label>
                                          <div className="col-sm-8">
                                            <input
                                        ...
                                        {/* Monthly Purchase */}
                                        <div className="row mb-3">
                                          <label htmlFor="Montly_Purchase" className="col-sm-4 col-form-label">
                                            Monthly Purchase:
                                          </label>
                                          <div className="col-sm-3">
                                            <input
                                          ...
                                          <label htmlFor="Discount_Per" className="col-sm-2 col-form-label">
                                            Discount Per:
                                          </label>
                                          <div className="col-sm-3">
                                            <input
                                    ...
                                    <div className="row text-end">
                                      <div className="col-md-12">
                                        ...
                                        <button type="button" className="subGernalbtn1" onClick={handleClear}>
                                          CLEAR
                                        </button>
                                      </div>
                                    </div>
                              ...
                              {isCardOpen && (
                                <div className="card card-custom">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCard}>
                                      ×
                                    </button>
                                  </div>
                              ...
                              {isCardOpenregion && (
                                <div className="card card-region">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardregion}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardRegion1 />
                              ...
                              {isCardOpenStateCode && (
                                <div className="card card-State">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardStateCode}>
                                      ×
                                    </button>
                                  </div>
                              ...
                              {isCardOpenPayment && (
                                <div className="card-Payment">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardPayment}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardPayment1 />
                              ...
                              {isCardOpenCountry && (
                                <div className="card-Country">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardCountry}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardCountry />
                              ...
                              {isCardOpenCurrency && (
                                <div className="card-Currency">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardCurrency}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardCurrency />
                              ...
                              {isCardOpenCity && (
                                <div className="card-City">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardCity}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardCity />
                              ...
                              {isCardOpenSector && (
                                <div className="card-Sector">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardSector}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardSector />
                              ...
                              {isCardOpenGroup && (
                                <div className="card-Group">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardGroup}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardGroup />
                              ...
                              {isCardOpenQMSCCode && (
                                <div className="card-QMSCCode">
                                  <div className="card-header d-flex justify-content-between">
                                    ...
                                    <button className="btn-close" onClick={toggleCardQMSCCode}>
                                      ×
                                    </button>
                                  </div>
                                  <ToggleCardQMSCode />
